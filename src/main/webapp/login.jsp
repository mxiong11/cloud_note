...
<div id="bottom">
    <div id="copyright">
        <div class="quick">
            <ul>
                <li><input type="button" class="quickbd iphone" onclick="location.href='https://github.com/'" /></li>
                <li><input type="button" class="quickbd android" onclick="location.href='https://github.com/'" /></li>
                <li><input type="button" class="quickbd pc" onclick="location.href='https://github.com/'" /></li>
                <div class="clr"></div>
            </ul>
            <div class="clr"></div>
        </div>
        <div class="text">
            Copyright © 2022  <a href="https://github.com/">mignmignmign</a>
        </div>
    </div>
</div>
</body>
